...
public class DList<T> extends List {
   ...
   **/
  protected DListNode<T> newNode(Object item, DList<T> list,
  ...
  public void insertFront(Object item) {
	  DListNode<T> n = newNode(item, this, head, head.next);
	  if (size == 0){
		  head.next = n;
		  head.prev = n;
	  }else{
  ...
  public void insertBack(Object item) {
    DListNode<T> n = newNode(item, this, head.prev, head);
    if(size == 0){
    	head.next = n;
    	head.prev = n;
    }else{
